...
//defaultcitywhatthepageloads
let cityInput = "London";
//addclickeventtoeachcityinthepanel
...
function fetchWeatherData() {
  fetch(
    `http://api.weatherapi.com/v1/current.json?key=3c6364ec6ed44b908b5195048230101&q=${cityInput}&aqi=yes`
  )
    ...
    .then((data) => {
      ...
      //dataOutput.innerHTML = dayofTheweek(d, m, y);
